	...
	var dzTheme = function(){
		...
		if(screenWidth <= 991)
		{
			if($('.mo-left .header-nav').children('.logo-header').length == 0){
				...
				jQuery('.header-style-2.mo-left .header-nav .logo-header > a > img').attr('src','images/logo.png');
